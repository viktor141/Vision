...
public class GuiSec extends GuiScreen {
    ...
    public GuiSec() {
        this.buttonList.add(new GuiButton(1, 10, 10, 50,20, "fff"));
    }
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100,  + 72 + 12, 98, 20, I18n.format("menu.options")));
        this.buttonList.add(new GuiButton(4, this.width / 2 + 2,  + 72 + 12, 98, 20, I18n.format("menu.quit")));
        this.buttonList.add(new GuiButtonLanguage(5, this.width / 2 - 124,  + 72 + 12));
        ...
        this.drawCenteredString(this.fontRenderer, "huila", 10, 20, -256);
    ...
    {
        this.buttonList.add(new GuiButton(1, 10, p_73969_1_, I18n.format("menu.singleplayer")));
        this.buttonList.add(new GuiButton(2, 10, p_73969_1_ + p_73969_2_ * 1, I18n.format("menu.multiplayer")));
