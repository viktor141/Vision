package com.cifrazia.vision.core.ui.text_fields;
...
public class SearchField extends Gui {
    ...
    public SearchField(int componentId, FontRenderer fontrendererObj, int x, int y)
    {
        this.id = componentId;
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            {
                Minecraft.getMinecraft().getTextureManager().bindTexture(Vision.NAVIGATION_SHOP_KIT);
                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
                GlStateManager.enableBlend();
                drawModalRectWithCustomSizedTexture(x, y, 342 >> 1, 262 >> 1, width, height, Vision.SIZE_OF_TEXTURE_KIT, Vision.SIZE_OF_TEXTURE_KIT);
            ...
            if (!s.isEmpty())
            {
                ...
                fontRenderer.drawStringWithShadow("§oSearch...", (float)l, (float)i1, Color.GRAY.getFullColor());
            }
